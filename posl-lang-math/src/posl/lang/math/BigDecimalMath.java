...
public class BigDecimalMath extends NumberMath {
	...
	// This is an arbitrary value, picked as a reasonable choice for a rounding
	// point
	...
	public Number divideImpl(Number left, Number right) {
		...
		return normalize(bigLeft.divide(bigRight, Math.max(scale,
				MAX_DIVISION_SCALE), BigDecimal.ROUND_HALF_UP));
